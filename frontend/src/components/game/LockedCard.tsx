...
/** The «Не відкрито» (undiscovered) card, faithful to the Claude Design v2 mock:
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `linear-gradient(90deg,transparent,${a(0.32)},transparent)`, opacity: 0.45 }}
      />
      ...
      <div className="flex flex-none items-center justify-between px-4 pt-3.5">
        ...
        <span
          className="inline-flex items-center gap-1.5 rounded-full border border-dashed px-2 py-1 font-mono text-[9.5px] uppercase tracking-[0.12em]"
          style={{ borderColor: a(0.32), background: a(0.05), color: a(0.6) }}
        >
          <svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke={a(0.6)} strokeWidth={2}>
      ...
      <div
        ...
        style={{ minHeight: 148, borderColor: a(0.14), background: `radial-gradient(120% 90% at 50% 30%, ${a(0.06)}, #070a0e 74%)` }}
      >
        <div className="absolute inset-0 bg-[repeating-linear-gradient(0deg,rgba(255,255,255,.03)_0_1px,transparent_1px_4px)]" />
        <div className="absolute h-[118px] w-[118px] rounded-full border border-dashed" style={{ borderColor: a(0.12) }} />
        <span
      ...
      <div className="flex-none px-4 pb-4 pt-0.5">
        <div className="min-h-[2.35em]">
          <div className="h-[15px] w-[58%] rounded-[5px]" style={{ background: `linear-gradient(90deg,${a(0.2)},${a(0.05)})` }} />
        </div>
