  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={`ml-auto flex h-full w-full max-w-md flex-col border-l border-white/10 bg-ink-900 shadow-2xl transition-transform duration-300 ease-out max-lg:mt-auto max-lg:h-[86%] max-lg:max-w-full max-lg:rounded-t-2xl max-lg:border-l-0 max-lg:border-t ${
          shown
