...
/** Navbar entry point: the account avatar (opens a dropdown menu) when signed
 * in, or a "Sign in" button (opens the modal) when signed out. Renders nothing
 * while the boot session refresh is still pending, to avoid a login-button flash. */
