...
export const THREAT_PATHS: Record<ThreatType, string> = {
  ...
  ballistic:
    'M12 23 C12.9 21.5 13.5 19.8 13.5 18 L13.5 7 L16 4 L16 2.2 L13.5 3.8 L13.5 1 L10.5 1 L10.5 3.8 L8 2.2 L8 4 L10.5 7 L10.5 18 C10.5 19.8 11.1 21.5 12 23 Z',
