...
_PROMPT = (
    ...
    "over a city only), kab (КАБ/авіабомба — a glide bomb released by an "
    "aircraft across the border, border raions only), ballistic (балістика/"
    "іскандер/кинджал/С-400/С-300), missile (крилата ракета/калібр/Х-101/"
    "generic ракета), or unknown. Use ballistic ONLY for an explicit ballistic marker; a bare "
