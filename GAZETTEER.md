...
| **Мила** (Kyiv, 2026-09-11) | 2 callouts, both beside Гореничі/Стоянка, and «мила» is an everyday adjective — the Веселе shape. Гореничі, 4 km away, now carries the pair. |
...
| **Віта** (Віта-Литовська alias, 2026-09-11) | вітаю / вітання as a stem | Whole-word only, so the greeting is unreachable; 12/12 bare callouts are the place, and every neighbour they are paired with (Заспа, Голосіїв, Південні) says Литовська, not Поштова. «Віта-Поштова» keeps its own hyphenated stem, which outranks the 4-letter alias inside its own name — pinned by a test |
| **Копита** (Ковпита alias, 2026-09-11) | hooves | The channel's own misspelling («Копита/Андріївка»), 1/1. Whole-word |
| **Красне** (Чернігівщина, 2026-09-11) | `красн` ⊂ Краснопалівка, Красноград, Краснопілля — 160 corpus hits, most of them Харківщина's corridor | Whole-word and `region_only`; 4/4 hits are the village, the Іванівська one by its neighbours both nights |
| **Лісне** (Чернігівщина, 2026-09-11) | `лісн` ⊂ Лісники (a Kyiv entry), «лісний масив» | Whole-word, which Харківщина's Лісне now shares — all 55 of its corpus hits already were whole-word, verified after the change |
| **Козари** (Чернігівщина, 2026-09-11) | `козар` ⊂ Козаровичі, Kyiv's village on this channel's own bank | Whole-word and `region_only`; 2/2 |
| **Вербове / Артеменків** (Чернігівщина, 2026-09-11) | «вербов» a street name; «артеменк» the surname Артеменко | Whole-word; 1/1 and 2/2, each called in beside a neighbour it sits next to (Терешківка; Олексинці) |
...
| 09-11 | **Y** — the admin coverage queue over the 10.6k messages since the 09-02 pass. Of its 1367 unlocalized rows 716 are Харківщина, still `active=False` and left alone (a separate decision — ~20 clear villages sit there, Гоптівка/Борщова/Феськи/Ков'яги/Есхар/…). For the live regions: Київщина gained Соцмісто (16 callouts, the Kyiv spotter's own name for the quarter between Дарниця and Нова Дарниця), Мишоловка, Гореничі, Віта-Литовська with its bare «Віта» (the second reversal of a documented rejection, in the whole-word form that dodges its reason), plus two aliases the list already needed — «лавін» (two channels spell the mall with an і) and «по морю» (22 callouts, the reservoir ride north). Чернігівщина gained 14: the Ковпита/Ведильці/Андріївка/Лісне cluster north-west of the city, Олбин/Підлісне/Красне/Козари south, Боромики by Березна, and the Срібнянська corridor Березівка/Олексинці/Артеменків plus Вербове/Терешківка. 75 Kyiv + 41 Chernihiv messages change, every one gains, nothing moves. Сумщина's queue held no place at all — its top unknown words were «відлетіла», «свої», «гарні». |
